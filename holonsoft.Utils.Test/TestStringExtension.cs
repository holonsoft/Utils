...
namespace holonsoft.Utils.Test
{
  public class TestStringExtension
  {
    ...
    public void TestConvertCase()
    {
      ...
      Assert.Equal("ThIS iS a VERY cRAZY STring!", result);
      ...
      Assert.Equal("anD a CRAZY oNe, too :-)", result);
    ...
    public void TestReplaceHTMLUmlauts()
    {
      ...
      Assert.Equal("&auml;&ouml;&uuml;&Auml;&Ouml;&Uuml;&szlig;<br>", h.ReplaceHTMLUmlauts(true));
    }
    ...
    public void TestAdjustLineFeedCharacters()
    {
      ...
      Assert.Equal("This is " + Environment.NewLine + "a line" + Environment.NewLine + "separated string", result);
    }
